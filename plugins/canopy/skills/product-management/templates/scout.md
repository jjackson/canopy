...
Before starting: Resolve `$CANOPY_PM_DIR` per the SKILL.md "Resolving the path" snippet (calls `resolve_pm_dir.sh`), then read `$CANOPY_PM_DIR/context.md` for project context — especially "What Matters Most".
