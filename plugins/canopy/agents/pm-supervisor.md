...
- When you identify a universal improvement, create a PR to `jjackson/canopy` (NOT the current project repo). Clone it to a temp directory if needed, branch from main, make the edit, push, and open the PR.
